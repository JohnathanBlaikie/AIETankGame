...
namespace MathHelpers
{
    public class V2
    {
        ...
        {
            return new V2((float)(lhs.x * rhs), (float)(lhs.y * rhs));
        }
        public static V2 operator *(float rhs, V2 lhs)
        {
            return new V2((float)(lhs.x * rhs), (float)(lhs.y * rhs));
        }
        ...
        public float Dot(V2 rhs)
        {
            return x * rhs.x + y * rhs.y;
        }

        float AngleBetween(V2 other)
        {
            V2 a = GetNormalized();
            V2 b = other.GetNormalized();
    ...
    public class Vector3
    {
        ...
        /// <summary>
        /// To accomodate Vector first Multiplication
        /// </summary>
        ...
        /// <summary>
        ///  To accomodate Vector first division
        /// </summary>
        /// <param name="lhs"></param>
        /// <param name="rhs"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// To accomodate float first multiplication
        /// </summary>
        /// <param name="lhs"></param>
        /// <param name="rhs"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// To accomodate float first division
        /// </summary>
        /// <param name="lhs"></param>
        /// <param name="rhs"></param>
        /// <returns></returns>
